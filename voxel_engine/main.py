#!/usr/bin/env python3
"""
VoxEx - The Python Voxel Explorer

Main entry point for the voxel engine with rendering, block interaction, and audio.
...
Usage:
    python -m voxel_engine.main
    # or
    python voxel_engine/main.py
