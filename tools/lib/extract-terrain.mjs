...
export function buildTerrainApi(file, seedStr, opts = {}) {
  ...
  const REGISTRY_KEYS = [
    ...
    'TECT_INTERIOR_FALLOFF', 'TECT_SMEAR', 'TECT_QUIET_LO', 'TECT_QUIET_HI', 'TECT_SEG_FLOOR', 'TECT_DRIFT_COHERENCE', 'TECT_CRUST_AMP', 'TECT_CRUST_BIAS', 'TECT_CRUST_FREQ_MULT', 'TECT_PLATE_TINT', 'TECT_FEATURE_KEEP', 'TECT_FEATURE_SEG_LEN', 'OROGEN_WIDTH', 'OROGEN_AMP', 'TRENCH_DEPTH_C', 'TRENCH_OFFSET',
