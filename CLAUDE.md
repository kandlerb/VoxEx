...
| `docs/shipped/terrain-detail-plan.md`, `docs/shipped/terrain-architecture-plan.md`, `docs/shipped/terrain-climate-fields-plan.md`, `docs/shipped/terrain-implementation-guide.md` | SHIPPED — produced the `terrainSurfac